...
echo -e "journalid\tjournalname\tissn" > journalidnameissn.tsv
cat Journals.txt | cut -f1,3,4,5 >> journalidnameissn.tsv
zip journalidnameissn.zip journalidnameissn.tsv
...
cut -f1,2,6 PaperAuthorAffiliationsNOPAT.txt | grep [a-zA-Z] >> paperauthoridaffiliationname.tsv
...
cat PapersNOPATS.txt | cut -f1,7 | grep [a-zA-Z] > booktitle.tsv
